  ...
  return (
    <main className='mr-6'>
       <div className='cardShop background_light'>
           <div className='cardHeader' style={{backgroundImage: `url(${props.img})`}}>
               <div className='columns m-1'>
                   <div className='column is-9 is-flex is-align-items-flex-end'>
                        <a className='is-size-4 hasBackground pr-1'>{props.name}<FontAwesomeIcon icon={faAngleRight}/></a>
                   </div>
                   <div className='column is-flex is-justify-content-flex-end'>
                   <a><FontAwesomeIcon className='iconFon  m-2' icon={faHeart} size="2x"/></a>
                   </div>
               </div>
           </div>
           <div className='card-body p-3 mt-1'>
           {
            ...
            <p className='mb-2'>{props.oeffnungszeiten.split("--").map((i,key) => {
